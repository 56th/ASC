...
%We have modified the manuscript accordingly. The changes in the manuscript are highlighted in red.
%We hope that the manuscript is now acceptable for publication in SISC.

%With this revision we also supply  supplementary material with the full animation of experiments 7.2 and 7.3. 
