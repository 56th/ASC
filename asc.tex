...
\begin{split}
			...
			\nabla\cdot\vect u    &+ c\,p           &= f       &\quad\text{in } \bcell, \\
			                      &\phantom{+cc\,}p &= \lambda &\quad\text{on } \partial\bcell, %\label{dual_mini:trace}
		%\end{empheq}
\end{split}
\right.&
